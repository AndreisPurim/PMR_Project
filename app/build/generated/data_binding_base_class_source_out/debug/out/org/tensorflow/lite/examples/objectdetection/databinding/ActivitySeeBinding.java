...
public final class ActivitySeeBinding implements ViewBinding {
  @NonNull
  ...
  public static ActivitySeeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_see, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySeeBinding bind(@NonNull View rootView) {
